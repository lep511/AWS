...
def lambda_handler(event, context):
    ...
    def update_cloudwatch():
        ...
        print('arn:aws:logs:us-east-1:{}:log-group:management-tools-week:*'.format(accountid))
    ...
    if trail and trail.get('trailList',[]):
        ...
        elif trail_desc['CloudWatchLogsLogGroupArn'] != 'arn:aws:logs:us-east-1:{}:log-group:ManagementToolsWeek/CloudTrail:*'.format(accountid):
            update_cloudwatch()
        else:
            print('All Good')
    # If no Trail is returned when describing, we will create the Trail.
        ...
        cloudtrail_client.create_trail(
            ...
            CloudWatchLogsLogGroupArn='arn:aws:logs:us-east-1:{}:log-group:ManagementToolsWeek/CloudTrail:*'.format(accountid),
